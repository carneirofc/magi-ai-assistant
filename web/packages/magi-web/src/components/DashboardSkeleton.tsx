// Route-transition skeleton for the dashboard group. Pulsing placeholders keep the
// shell stable while a server page streams in. Mount it from a `loading.tsx`.
